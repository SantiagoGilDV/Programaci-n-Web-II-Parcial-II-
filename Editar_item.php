...
if (!$art) die("Artista no encontrado");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $up = $conn->prepare($sql);
    if (!$up) die("Error prepare: " . $conn->error);
...
<div class="admin-wrap">
  ...
  <form class="form-admin" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-row">
      ...
      <input type="text" name="Nombre_Artistico" value="<?php echo htmlspecialchars($art['Nombre_Artistico'] ?? ''); ?>">
    </div>

    <div class="form-row">
      <label>Nombre artístico anterior:</label>
      <input type="text" name="Nombre_Artistico_Anterior" value="<?php echo htmlspecialchars($art['Nombre_Artistico_Anterior'] ?? ''); ?>">
    </div>
    ...
    <div class="form-row">
      ...
      <input type="date" name="Inicio_Actividad" value="<?php echo htmlspecialchars($art['Inicio_Actividad'] ?? ''); ?>">
    </div>

    <div class="form-row">
      <label>Fecha nacimiento:</label>
      <input type="date" name="Fecha_Nacimiento" value="<?php echo htmlspecialchars($art['Fecha_Nacimiento'] ?? ''); ?>">
    </div>
